...
// 在改变刷新状态时，会setNeedDisplay，最后会调用layoutSubviews，layoutSubviews中会调用该方法
- (void)placeSubviews
{
    [super placeSubviews];
...
- (void)scrollViewContentOffsetDidChange:(NSDictionary *)change
{
    ...
    if (self.state == MJRefreshStateRefreshing) {
        ...
        // sectionheader停留解决
        // 取  - self.scrollView.mj_offsetY  和  _scrollViewOriginalInset.top 的较大值
